...
public class UserTest {
    ...
    @Test
    public void canUsePublicField() {
        User auser = new User("bob","1234");
        assertEquals("new user name", "bob", auser.getUsername());
        assertEquals("new user name", "1234", auser.getPassword());
    }
} */
